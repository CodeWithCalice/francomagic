...
![CI](https://github.com/j8r/core-entity_modifier/workflows/CI/badge.svg)
...
`<object>` can be an entity model (as listed with `/list_entities`) or an [Itemstring](https://wiki.core.net/Itemstrings) (e.g. `default:dirt`).
...
`/clipboard .<property>`: Print a property of the copied model, see https://core.gitlab.io/core/definition-tables/#object-properties.
